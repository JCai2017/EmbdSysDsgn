...
#line 619 "susan_edge_detector.h"
...
#line 625 "susan_edge_detector.h"
...
#line 643 "susan_edge_detector.h"
...
#line 649 "susan_edge_detector.h"
...
#line 655 "susan_edge_detector.h"
...
#line 679 "susan_edge_detector.h"
...
#line 685 "susan_edge_detector.h"
...
#line 843 "susan_edge_detector.h"
...
#line 857 "susan_edge_detector.h"
...
#line 871 "susan_edge_detector.h"
...
#line 899 "susan_edge_detector.h"
...
#line 913 "susan_edge_detector.h"
...
#line 927 "susan_edge_detector.h"
...
#line 941 "susan_edge_detector.h"
...
#line 955 "susan_edge_detector.h"
...
#line 983 "susan_edge_detector.h"
...
#line 997 "susan_edge_detector.h"
    virtual ~i_send(void){};
...
#line 1011 "susan_edge_detector.h"
...
#line 1025 "susan_edge_detector.h"
...
#line 1053 "susan_edge_detector.h"
    OS_channel();
...
#line 1102 "susan_edge_detector.h"
...
#line 1128 "susan_edge_detector.h"
...
#line 1150 "susan_edge_detector.h"
...
#line 1201 "susan_edge_detector.h"
...
#line 1235 "susan_edge_detector.h"
...
#line 1322 "susan_edge_detector.h"
...
#line 1358 "susan_edge_detector.h"
...
#line 1383 "susan_edge_detector.h"
...
#line 1403 "susan_edge_detector.h"
...
#line 346 "susan_edges.sc"
class SusanEdges : public _specc::behavior
{
private:

#line 346 "susan_edges.sc"
    i_uchar7220_receiver (&in_image); i_int7220_sender_os (&out_r); i_uchar7220_sender_os (&out_mid); unsigned char (&bp)[516]; i_uchar7220_sender_os (&out_image); OSAPI (&os);
public:

#line 1428 "susan_edge_detector.h"
    SusanEdges(unsigned int _idcnt, i_uchar7220_receiver (&in_image), i_int7220_sender_os (&out_r), i_uchar7220_sender_os (&out_mid), unsigned char (&bp)[516], i_uchar7220_sender_os (&out_image), OSAPI (&os));
    virtual ~SusanEdges(void);
    void main(void);
private:

#line 349 "susan_edges.sc"
...
#line 10 "detect_edges.sc"
class DetectEdges : public _specc::behavior
{
private:

#line 10 "detect_edges.sc"
    i_uchar7220_receiver (&in_image); i_int7220_sender_os (&out_r); i_uchar7220_sender_os (&out_mid); i_uchar7220_sender_os (&out_image); OSAPI (&os);
public:

#line 1462 "susan_edge_detector.h"
    DetectEdges(unsigned int _idcnt, i_uchar7220_receiver (&in_image), i_int7220_sender_os (&out_r), i_uchar7220_sender_os (&out_mid), i_uchar7220_sender_os (&out_image), OSAPI (&os));
...
#line 1484 "susan_edge_detector.h"
    Edges(unsigned int _idcnt, i_uchar7220_receiver (&in_image), i_int7220_sender_os (&out_r), i_uchar7220_sender_os (&out_mid), i_uchar7220_sender_os (&out_image), OSAPI (&os));
    virtual ~Edges(void);
    int init(void);
    void main(void);
private:
...
#line 1523 "susan_edge_detector.h"
...
#line 1539 "susan_edge_detector.h"
...
#line 1559 "susan_edge_detector.h"
...
#line 142 "edge_draw.sc"
    i_uchar7220_receiver_os (&in_image); i_uchar7220_receiver_os (&in_mid); i_uchar7220_sender (&out_image); OSAPI (&os);
public:

#line 1629 "susan_edge_detector.h"
    EdgeDraw(unsigned int _idcnt, i_uchar7220_receiver_os (&in_image), i_uchar7220_receiver_os (&in_mid), i_uchar7220_sender (&out_image), OSAPI (&os));
...
#line 1658 "susan_edge_detector.h"
    Draw(unsigned int _idcnt, i_uchar7220_receiver_os (&in_image), i_uchar7220_receiver_os (&in_mid), i_uchar7220_sender (&out_image), OSAPI (&os));
    virtual ~Draw(void);
    int init(void);
    void main(void);
private:
...
#line 1681 "susan_edge_detector.h"
...
#line 1697 "susan_edge_detector.h"
...
#line 1713 "susan_edge_detector.h"
...
#line 1758 "susan_edge_detector.h"
...
#line 13 "susan.sc"
    i_uchar7220_receiver (&in_image); i_uchar7220_sender (&out_image); OSAPI (&os);
public:

#line 1793 "susan_edge_detector.h"
    Susan(unsigned int _idcnt, i_uchar7220_receiver (&in_image), i_uchar7220_sender (&out_image), OSAPI (&os));
    virtual ~Susan(void);
    int init(void);
    void main(void);
private:
...
#line 1837 "susan_edge_detector.h"
...
#line 1862 "susan_edge_detector.h"
...
#line 24 "design.sc"
    i_receive (&start); unsigned char (&image_buffer)[7220]; i_uchar7220_sender (&in_image);
public:
...
#line 1897 "susan_edge_detector.h"
...
#line 33 "design.sc"
    i_uchar7220_receiver (&out_image); i_sender (&out_image_susan);
public:

#line 1913 "susan_edge_detector.h"
...
#line 1932 "susan_edge_detector.h"
...
#line 1965 "susan_edge_detector.h"
...
#line 1981 "susan_edge_detector.h"
...
#line 1996 "susan_edge_detector.h"
...
#line 3018 "susan_edge_detector.h"
