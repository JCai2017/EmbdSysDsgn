// i_typed_receiver_os.sh: template (macro) for a typed receiver interface
//
...
#ifndef I_TYPED_RECEIVER_OS_SH
#define I_TYPED_RECEIVER_OS_SH


#define DEFINE_I_TYPED_RECEIVER_OS(typename, type)				\
									\
interface i_ ## typename ## _receiver_os					\
{									\
    note _SCE_STANDARD_LIB = { "i_receiver_os", #typename, #type };	\
									\
    void receive(type *d);						\
};


#endif /* I_TYPED_RECEIVER_OS_SH */


// EOF i_typed_receiver_os.sh
